...
import BentoCard from "@/views/root/main/ui/sections/features/ui/components/bento-card";
import BentoTilt from "@/views/root/main/ui/sections/features/ui/components/bento-tilt";
			...
			<div className={"container mx-auto px-3 md:px-10"}>
				...
				<BentoTilt className={"relative border-hsla mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]"}>
					<BentoCard
						...
						description={
							"A cross-platform meta game app, turning your activities across Web2 and Web3 games into a rewarding adventure."
						}
					/>
				</BentoTilt>
